...
void ResultsDisassemblyPage::showDisassemblyBySymbol() {
    ...
    QString processName =
            m_objdump + QLatin1String(" --disassemble=") + m_curSymbol.symbol + QLatin1String(" ") + m_curSymbol.path;
...
void ResultsDisassemblyPage::showDisassemblyByAddressRange() {
    ...
    if (m_curSymbol.size == 0) {
        processName =
                m_objdump + QLatin1String(" --disassemble=") + m_curSymbol.symbol + QLatin1String(" ") +
                m_curSymbol.path;
    }
    showDisassembly(processName);
}
