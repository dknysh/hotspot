...
public:
    ...
    void addSymbol(const SymbolDefinition& symbol)
    {
        ...
        bottomUpResult.symbols[symbol.id] = {symbolString, relAddrString, sizeString, binaryString, pathString};
                                ...
                                const QString& targetRoot, const QString& arch)
{
    ...
    m_events = {};
    m_disassemblyResult = {};
    m_disassemblyResult.setData(path, appPath, targetRoot, extraLibPaths, arch);
